...
interface VisitService {
    suspend fun register(name: String, email: String, phone: String, street: String?, zip: String?, city: String?, country: String?, locationShortname: String, timestampStr: String? = null, tableNumber: String?, sector: String?, suppressEmail: Boolean = false): Visit
